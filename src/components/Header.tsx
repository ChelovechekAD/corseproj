...
import { Context, orderCartStore, store } from '../Context';
  ...
  return (
    <header>
        ...
        <div>
            ...
            <FaCartShopping onClick={()=>loadCart(orderCartStore, functionalStore)} className={`shop-cart-button ${orderCartStore.cartOpen && 'active'}`}/>
